...
public class ClienteDao  {
    ...
    public int countNovosClientes() {
        ...
        String sql = "select count(DISTINCT cliente.id) from cliente join contrato on cliente.id = contrato.id_cliente where EXTRACT(MONTH FROM cliente.data_entrada) = " +
    ...
    public List<Cliente> listarClientesComContato() throws SQLException, ClassNotFoundException {
        ...
        while (rs.next()) {
            ...
            Contato contato = new Contato();
            contato.setNome(rs.getString("contnome"));
            contato.setEmail(rs.getString("email"));
            contato.setTelefone(rs.getString("telefone"));
